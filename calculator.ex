defmodule Calculator do
  @moduledoc """
  Define a Calculator module and functionsto execute it.
  """
  ...
  def start() do
    ...
    kaua  = %Student{name: "Kauã Camboinhas",results: build_subjects([5.4, 4.9, 2.2, 3.8])}
  ...
  ## Parameters
  - `student` - A list of Student structs.
  """
